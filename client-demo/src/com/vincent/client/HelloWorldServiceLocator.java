...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.vincent.client.HelloWorldService {
    ...
    public com.vincent.client.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public com.vincent.client.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.vincent.client.HelloWorldSoapBindingStub _stub = new com.vincent.client.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.vincent.client.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.vincent.client.HelloWorldSoapBindingStub _stub = new com.vincent.client.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
